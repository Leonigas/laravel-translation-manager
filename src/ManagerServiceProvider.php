...
class ManagerServiceProvider extends ServiceProvider {
	...
	public function register()
	{
        ...
        $this->app->singleton('command.translation-manager.replace', function ($app) {
            return new Console\ReplaceCommand($app['translation-manager']);
        });
        $this->commands('command.translation-manager.replace');
	}
	...
	public function provides()
	{
		return array('translation-manager',
            ...
            'command.translation-manager.replace'
        );
	}
